...
<template>
    ...
    <div
        ...
        :style="{
            backgroundImage: `url(/storage/pageContent/${page.props.gallery.image})`,
    ...
    >
        <div class="container text-center py-5" style="max-width: 900px">
            <h3 class="text-white display-3 mb-4">{{ page.props.gallery.title }}</h3>
    ...
    <div class="container-fluid gallery py-5 my-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px">
            ...
            <div v-html="page.props.gallery.description"></div>
        </div>
