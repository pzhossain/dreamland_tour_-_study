...
const currentImage = props.pageContentImage
    ? `/storage/pageContent/${props.pageContentImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : pageContentImage ? `/storage/pageContent/${pageContentImage}` : 'placeholder.png'"
