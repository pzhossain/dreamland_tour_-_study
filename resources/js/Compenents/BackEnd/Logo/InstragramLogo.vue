...
const currentImage = props.instragramLogo
    ? `/storage/logo/${props.instragramLogo}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : instragramLogo ? `/storage/logo/${instragramLogo}` : 'placeholder.png'"
