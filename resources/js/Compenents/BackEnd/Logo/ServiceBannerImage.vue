...
const currentImage = props.serviceBannerImage
    ? `/storage/logo/${props.serviceBannerImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : serviceBannerImage ? `/storage/logo/${serviceBannerImage}` : 'placeholder.png'"
        class="img-thumbnail border border-dark rounded w-100"
        style="width: 100px; height: 100px; object-fit: cover;"
        alt="Service Banner Logo"
      />
    </label>
