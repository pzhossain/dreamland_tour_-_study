...
const currentImage = props.contactBannerImage
    ? `/storage/logo/${props.contactBannerImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : contactBannerImage ? `/storage/logo/${contactBannerImage}` : 'placeholder.png'"
