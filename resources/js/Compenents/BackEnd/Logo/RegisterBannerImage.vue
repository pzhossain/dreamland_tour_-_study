...
const currentImage = props.registerBannerImage
    ? `/storage/logo/${props.registerBannerImage}`
    : null;
...
<template>
  <div class="position-relative d-inline-block">
    <label for="image" class="d-block">
      <img
        :src="preview ? preview : registerBannerImage ? `/storage/logo/${registerBannerImage}` : 'placeholder.png'"
        class="img-thumbnail border border-dark rounded w-100"
        style="width: 100px; height: 100px; object-fit: cover;"
        alt="Register Banner Logo"
      />
    </label>
