      ...
      <nav class="admin-navbar admin-bg-light admin-navbar-light">
        ...
        <div class="admin-navbar-nav w-100 d-flex flex-column gy-2 mt-3">
          ...
          <Link
            ...
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/countries') ? 'active' : '']"
          >
          ...
          <Link
            href="/admin/bookings"
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/bookings') ? 'active' : '']"
          >
          ...
          <Link
            ...
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/success-stories') ? 'active' : '']"
          >
          ...
          <Link
            href="/admin/reviews"
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/reviews') ? 'active' : '']"
          >
          ...
          <Link
            ...
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/service-categories') ? 'active' : '']"
          >
          ...
          <Link
            href="/admin/services"
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/services') ? 'active' : '']"
          >
          ...
          <Link
            href="/admin/roles"
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/roles') ? 'active' : '']"
          >
          ...
          <Link
            href="/admin/users"
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/users') ? 'active' : '']"
          >
          ...
          <Link
            href="/admin/students"
            :class="['admin-nav-item admin-nav-link', isActiveRoute('/students') ? 'active' : '']"
          >
        ...
        <div class="admin-navbar-nav align-items-center ms-auto">
          <div class="admin-nav-item dropdown">
            <a href="#" class="admin-nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <span class="d-none d-lg-inline-flex">{{ page.props.user.name }}</span>
            </a>
